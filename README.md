...
IMO는 운동 중 근전도(EMG)와 관성센서(IMU) 데이터를 수집해 운동 수행 상태, 근육 활성도, 좌우 밸런스, 보상 동작을 분석하는 웨어러블 운동 보조 서비스입니다.  
Flutter 앱, FastAPI 백엔드, Raspberry Pi, ESP32-S3 센서 펌웨어가 연결되어 실시간 운동 데이터 수집과 피드백 흐름을 구성합니다.
