# ESP32-Pi 패킷 포맷 v1 (JSONL Archive)

이 문서는 초기 시도안이었던 **텍스트 기반 JSON Lines(JSONL) 프로토콜**을 보존하기 위한 archive 문서입니다.

- 상태: `archive`
- 사용 목적: 초기 bring-up, 디버깅, 호환성 참고
- 후속 방향: 실시간성 개선을 위해 v2 바이너리 프로토콜로 전환
